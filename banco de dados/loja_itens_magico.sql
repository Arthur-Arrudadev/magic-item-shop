...
--
-- Host: 127.0.0.1
-- Tempo de geração: 01/06/2025 às 01:21
...
--
ALTER TABLE `encantamentos`
  MODIFY `encantamento_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `missoes`
  MODIFY `missao_id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `historico_compras_clientes`
  ...
  ADD CONSTRAINT `historico_compras_clientes_ibfk_3` FOREIGN KEY (`venda_id`) REFERENCES `vendas` (`venda_id`) ON DELETE SET NULL;
...
--
ALTER TABLE `itens_encantamentos`
  ADD CONSTRAINT `itens_encantamentos_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `itensmagicos` (`item_id`) ON DELETE CASCADE,
